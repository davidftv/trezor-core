...
class Loader(ui.Widget):
    ...
    def __init__(self, target_ms=1000, loader_style=ui.LDR_DEFAULT):
        self.target_ms = target_ms
        self.start_ticks_ms = None
        self.normal_style = loader_style['normal'] or ui.LDR_DEFAULT['normal']
        self.active_style = loader_style['active'] or ui.LDR_DEFAULT['active']
